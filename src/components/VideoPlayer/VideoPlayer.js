...
function VideoPlayer () {
    ...
    if (isError) {
        return <ErrorOutlineIcon severity="error" className='loading'>No Results found!</ErrorOutlineIcon>
    }
    return (
        <div className='videoplayer'>
            <div className='videoplayer_videodetails'>
                <div className='videoplayer_video'>
                    {isLoading ? <CachedIcon className='loading' color='secondary' /> : <Video videoId={videoId} />}
                </div>
